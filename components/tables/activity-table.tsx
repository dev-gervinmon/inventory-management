...
import { formatActivityDate } from "@/lib/utils/activities";
import {
        ...
        {isEmpty ? (
          ...
          paginatedItems.map((activity) => {
            ...
            return (
              <div
                key={activity.id}
                className="bg-white rounded-lg border border-gray-200 p-4 hover:border-gray-300 hover:shadow-sm transition"
              >
